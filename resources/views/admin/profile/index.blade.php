...
@section('content')
            ...
            <div class="row mt-sm-4">
              <div class="col-12 col-md-12 col-lg-5">
                <div class="card profile-widget">
                  <div class="profile-widget-header">                     
                    <img alt="image" src="{{ asset($admin->avatar) }}" class="rounded-circle profile-widget-picture">
              ...
              <div class="col-12 col-md-12 col-lg-7">
                <div class="card">
                  <form action="{{ route('admin.updateProfile') }}" method="post" class="needs-validation" enctype="multipart/form-data">
                  @csrf
                  @method('put')
